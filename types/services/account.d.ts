...
export declare class Account extends Service {
   ...
   * @returns {Promise}
   */
  updateEmail<Preferences extends Models.Preferences>(
    email: string,
    password: string,
  ): Promise<Models.User<Preferences>>;
  /**
   ...
   * @returns {Promise}
   */
  updateMFA<Preferences extends Models.Preferences>(
    mfa: boolean,
  ): Promise<Models.User<Preferences>>;
  /**
   * Add Authenticator
   ...
   * @returns {Promise}
   */
  updateMfaAuthenticator<Preferences extends Models.Preferences>(
   ...
   * @returns {Promise}
   */
  updateName<Preferences extends Models.Preferences>(
    name: string,
  ): Promise<Models.User<Preferences>>;
  /**
   * Update password
   ...
   * @returns {Promise}
   */
  updatePassword<Preferences extends Models.Preferences>(
    password: string,
    oldPassword?: string,
  ): Promise<Models.User<Preferences>>;
  /**
   ...
   * @returns {Promise}
   */
  updatePrefs<Preferences extends Models.Preferences>(
    prefs: object,
  ): Promise<Models.User<Preferences>>;
  /**
